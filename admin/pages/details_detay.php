...
<head>
    ...
    <title>Details Detay | Panel</title>
...
$aktif=$db->prepare("UPDATE `blog_details` SET `aktif`= :aktif WHERE `id`= :i");//ileşim tablosundna verileri id ye göre çeker
    ...
    <div id="wrapper">
      ...
      <?php require_once 'inc-menu.php';    ?> <!-- menu kodlarını buradan taşıdığımız için taşıdığımız sayfanın uzantısını buraya veriyoruz -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Açıklama(<?=$id ?>) </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <a href="details.php" class="btn btn-primary">Geri Dön</a>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form>
                                       ...
                                       <div class="form-group">
                                        <p><b>Başlık:</b><?= $row["baslik"]?></p>
                                          <p><b>Açıklama:</b><?= $row["aciklama"]?></p>
                                           <p><b>Tarih:</b><?= $row["tarih"]?></p>
                                           
                                       </div>
                                       <a href="details.php?silme=sil&id=<?= $row["id"]?>" onclick="return confirm('silmek istediğinize emin misiniz?')" class="btn btn-danger btn-xs" style="margin-right: 15px;">Sil</a>
