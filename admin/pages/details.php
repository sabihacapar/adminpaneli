...
//aktiflik durumunu değiştirmek için kullanılır
    ...
    if(@$_GET["silme"]=="sil"){
        ...
        if($sil->execute()){
            header("Location: details.php?i=ekle");
        }else{
             header("Location: details.php?info=ekle");
...
<?php  require_once 'inc-menu.php'; ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">DETAİLS</h1>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
                                        $sql=$db->prepare("SELECT * FROM `blog_details` ORDER BY `id` DESC");
                                        $sql->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <a href="details_detay.php?id=<?= $row["id"]?>" class="btn btn-warning btn-xs" style="margin-right: 15px;">Oku</a>
                                            </td>
                                             <td class="center">
